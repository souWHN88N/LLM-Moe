...
DATA_DIR_PATH = os.path.join(os.path.dirname(__file__), os.pardir, 'dataset')
#
# Cora specific information
#
# this is checked-in no need to make a directory
...
CITESEER_TEST_RANGE = [2327, 2327+1000]
...
#
PPI_URL = 'https://data.dgl.ai/dataset/ppi.zip'  # preprocessed PPI dataset from Deep Graph Library
